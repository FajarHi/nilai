...
<select class="form-control" name="semester" required="">
    ...
    <option value="2">Semester Genap / Dua</option>
        ...
        <tr><td><button type="submit" class="btn btn-primary" name="kirim">
                    <i class="glyphicon glyphicon-floppy-disk"></i> Cari 
                </button>
...
<table id="example1" class="table table-bordered table-striped">
            ...
            <td><a href="<?= base_url('cetak/raport/'.$hasil['id_siswa'].'/'.$hasil['semester']) ?>" class="btn btn-primary"><i class="fa fa-print"></i>Cetak Nilai Raport</a>&nbsp;
            </td>
            </tr>
