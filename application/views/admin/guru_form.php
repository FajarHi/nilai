...
<table class="table table-striped">
		...
		<tr><td>Password</td><td><input type="text" name="password" class="form-control" value="<?= $nama ?>" required=""></td></tr>

		<tr><td>Email</td><td><input type="email" name="email" class="form-control" value="<?= $email ?>" required=""></td></tr>

		<tr><td>Nip</td><td><input type="text" name="nip" class="form-control"  value="<?= $nip ?>" required=""></td></tr>
